...
//    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiData<String> handleException(DataIntegrityViolationException exception){
        log.error(exception.getMessage(), exception);
        return ApiData.error(ErrorCode.NON_TRANSACTION_ERROR, exception.getRootCause().getMessage());
    }
